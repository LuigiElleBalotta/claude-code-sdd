 ...
 */
export function parseTaskList(markdown, options = {}) {
    ...
    for (let i = sectionStart; i < sectionEnd; i++) {
        ...
        const node = { label, title: title.length > 0 ? title : rest, done, children: [], line: i + 1 };
...
//# sourceMappingURL=parse-task-list.js.map